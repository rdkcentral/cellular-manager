                                                ...
                                                gpointer user_data)
{
    ...
    if (qmi_message_nas_get_cell_location_info_output_get_interfrequency_lte_info(
            output, NULL, &pInterFreq, &error) && pInterFreq) {
    ...
    for (guint i = 0; i < pIntraFreqCells->len && idx < totalCnt; i++) {
