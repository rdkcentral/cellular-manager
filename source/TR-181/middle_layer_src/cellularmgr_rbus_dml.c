...
rbusError_t cellularmgr_Init()
{
    ...
    CellularMgr_Device_Mode_RBUS_Handler_Subscribe();
...
pstDmlCellular->X_RDK_Status = CellularMgrSMGetCurrentState( );
    ...
    {
        CellularMgr_GetModemVendor(pstDmlCellular->X_RDK_Vendor);
...
rbusError_t Cellular_SetParamBoolValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusSetHandlerOptions_t* opts)
{
    ...
    if(strcmp(context.name, "X_RDK_Enable") == 0)
    {
        ...
        if( val != pstDmlCellular->X_RDK_Enable )
        {
            ...
            {
                CcspTraceInfo(("%s-%d : Failed to set X_RDK_Enable to %d \n",__FUNCTION__, __LINE__, val));
                return RBUS_ERROR_BUS_ERROR;
            }
        }
        /*context.userData is this objects data and val is the property's new value*/
...
static rbusError_t X_RDK_Statistics_GetParamUlongValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusGetHandlerOptions_t* opts)
{
    ...
    CellularMgr_NetworkPacketStatisticsUpdate(pstStatsInfo);
    ...
    else if(strcmp(context.name, "TotalUserBytesSent") == 0)
    {
        rbusProperty_SetUInt64(property, g_extender_stats.TotalUserBytesSent);
    }
    else if(strcmp(context.name, "TotalUserBytesReceived") == 0)
    {
        rbusProperty_SetUInt64(property, g_extender_stats.TotalUserBytesReceived);
    }
    else if(strcmp(context.name, "GFOUserBytesSent") == 0)
    {
        rbusProperty_SetUInt64(property, g_extender_stats.GFOUserBytesSent);
    }
    else if(strcmp(context.name, "GFOUserBytesReceived") == 0)
    {
        rbusProperty_SetUInt64(property, g_extender_stats.GFOUserBytesReceived);
    }
    else
    {
        return RBUS_ERROR_INVALID_INPUT;
...
static rbusError_t X_RDK_Statistics_UserResetCount_GetParamUlongValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusGetHandlerOptions_t* opts)
{
    HandlerContext context = GetPropertyContext(property);

   if(strcmp(context.name, "UserResetCount") == 0)
    {
        rbusProperty_SetUInt64(property, g_extender_stats.UserResetCount);
    }
    else
    {
        return RBUS_ERROR_INVALID_INPUT;
...
rbusError_t registerGeneratedDataElements(rbusHandle_t handle)
{
	...
	{"Device.Cellular.Interface.{i}.X_RDK_PlmnAccess.AvailableNetworks.{i}.Mcc", RBUS_ELEMENT_TYPE_PROPERTY, {AvailableNetworks_GetParamStringValue_rbus, NULL, NULL, NULL, NULL, NULL}},
        ...
        {"Device.Cellular.Interface.{i}.X_RDK_Statistics.TotalUserBytesSent", RBUS_ELEMENT_TYPE_PROPERTY, {X_RDK_Statistics_GetParamUlongValue_rbus, NULL, NULL, NULL, CellularMgrDmlSubscriptionHandler, NULL}},
        {"Device.Cellular.Interface.{i}.X_RDK_Statistics.TotalUserBytesReceived", RBUS_ELEMENT_TYPE_PROPERTY, {X_RDK_Statistics_GetParamUlongValue_rbus, NULL, NULL, NULL, CellularMgrDmlSubscriptionHandler, NULL}},
        {"Device.Cellular.Interface.{i}.X_RDK_Statistics.GFOUserBytesSent", RBUS_ELEMENT_TYPE_PROPERTY, {X_RDK_Statistics_GetParamUlongValue_rbus, NULL, NULL, NULL, CellularMgrDmlSubscriptionHandler, NULL}},
        {"Device.Cellular.Interface.{i}.X_RDK_Statistics.GFOUserBytesReceived", RBUS_ELEMENT_TYPE_PROPERTY, {X_RDK_Statistics_GetParamUlongValue_rbus, NULL, NULL, NULL, CellularMgrDmlSubscriptionHandler, NULL}},
        {"Device.Cellular.Interface.{i}.X_RDK_Statistics.UserResetCount", RBUS_ELEMENT_TYPE_PROPERTY, {X_RDK_Statistics_UserResetCount_GetParamUlongValue_rbus, NULL, NULL, NULL, CellularMgrDmlSubscriptionHandler, NULL}},
